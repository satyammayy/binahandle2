...
const Lang = Language.getString('_bina');

if (Config.WORKTYPE == 'private') {

    Asena.addCommand({pattern: 'bina ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●*Bina Bot-Satyam Mayengbam Private*●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
    ...
    Asena.addCommand({pattern: 'bina ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'● *Bina Bot-Satyam Mayengbam Public* ●\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
    ...
    Asena.addCommand({pattern: 'bina ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            if (CMD_HELP === '') CMD_HELP += Lang.NOT_FOUND;
            await message.client.sendMessage(
                message.jid,'● *Bina Bot-Satyam Mayengbam Pubilc* ●\n\n' + CMD_HELP, MessageType.text
            );
        }
    }));
}
